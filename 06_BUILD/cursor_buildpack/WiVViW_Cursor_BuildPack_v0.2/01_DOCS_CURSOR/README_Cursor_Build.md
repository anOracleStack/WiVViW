# WiVViW — Cursor Build Pack (v0.1) — 2026-02-19

This pack adapts the WiVViW canon for building in **Cursor** (code-first), not Lovable.

## What to do (fast path)
1) Open `02_APP_SCAFFOLD/wivviw-ui/` in Cursor
2) In a terminal:
   - `npm install`
   - `npm run dev`

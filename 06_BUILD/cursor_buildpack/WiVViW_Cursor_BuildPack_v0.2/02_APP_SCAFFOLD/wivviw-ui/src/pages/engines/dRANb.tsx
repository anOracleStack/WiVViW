    ...
    <div className="p-4">
      <div className="glass rounded-2xl p-5 border border-white/10">
        <div className="flex items-center justify-between">
          <div>
            <div className="text-lg text-white/90">dRANb Naming Engine</div>
            <div className="text-sm text-white/55 mt-1">Generate, evaluate, & shortlist brand name candidates.</div>
          </div>
...
const title = 'dRANb Naming Engine'
const subtitle = 'Generate, evaluate, & shortlist brand name candidates.'

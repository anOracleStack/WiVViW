...
export const ENGINE_REGISTRY: Record<EngineId, EngineMeta> = {
  dranb: {
    ...
    label: "dRANb",
    friendlyLabel: "Name",
    outcomeHint: "Find a brand name worth owning",
    sub: "Naming · Decision",
  ...
  brandl: {
    ...
    outcomeHint: "Secure your name across all digital fronts",
  ...
  "4ield": {
    ...
    label: "4IELD",
    friendlyLabel: "Field",
    outcomeHint: "See what else occupies your space",
  ...
  "3xec": {
    ...
    label: "3XEC",
    friendlyLabel: "Exec",
    outcomeHint: "Mission, plan, and ops you run daily",
  ...
  "5ite": {
    ...
    label: "5ITE",
    friendlyLabel: "Site",
    outcomeHint: "Build and launch your digital real estate",
    sub: "Product · Deploy",
  ...
  "6roxy": {
    ...
    label: "6ROXY",
    friendlyLabel: "Proxy",
    outcomeHint: "Your twin — voice, calendar, on while you sleep",

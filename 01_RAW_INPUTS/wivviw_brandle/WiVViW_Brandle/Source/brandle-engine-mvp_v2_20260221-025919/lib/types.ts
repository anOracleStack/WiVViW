...
export type Candidate = {
  ...
  signals: { domain: Signal; handles: { platform: string; signal: Signal }[]; trademark: Signal; };
  updatedAt: string;
};
export type ChapterReport = {
  chapterId: string; engineName: "dRANb"; startedAt: string; confirmedContext: Record<string, any>;
  goals: string[]; constraints: string[]; namesExplored: { promising: string[]; shortlisted: string[]; selected?: string };

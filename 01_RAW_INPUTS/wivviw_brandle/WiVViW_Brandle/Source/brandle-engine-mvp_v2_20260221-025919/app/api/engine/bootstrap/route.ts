...
const QUOTES = [
  { id: "q1", text: "No hype. No guarantees. Just decisions.", tags: ["dRANb","general"] },
  { id: "q2", text: "Clarity is a form of courage.", tags: ["dRANb","general"] },
  { id: "q3", text: "A name is a promise you’ll be judged against.", tags: ["dRANb"] },
  { id: "q4", text: "If you can’t say it, you can’t scale it.", tags: ["dRANb"] },
  { id: "q5", text: "Ownability beats cleverness when money is on the line.", tags: ["brandL"] },
];
...
const TRENDS = [
  ...
  },
  {
    ...
    title: "New gTLD round expected in 2026",
...
export async function GET(request: Request) {
  ...
  const trends = TRENDS.filter((t) => t.engineTags.includes(engine)).slice(0, 6);

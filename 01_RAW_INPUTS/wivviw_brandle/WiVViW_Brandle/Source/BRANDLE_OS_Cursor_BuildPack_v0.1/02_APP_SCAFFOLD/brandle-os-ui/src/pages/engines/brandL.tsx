...
export default function brandL() {
    ...
    <div className="p-4">
      <div className="glass rounded-2xl p-5 border border-white/10">
        <div className="flex items-center justify-between">
          <div>
            <div className="text-lg text-white/90">brandL Identity Consolidation</div>
            <div className="text-sm text-white/55 mt-1">Domain & handle ladder strategy for shortlisted names.</div>
          </div>
...
const title = 'brandL Identity Consolidation'
const subtitle = 'Domain & handle ladder strategy for shortlisted names.'

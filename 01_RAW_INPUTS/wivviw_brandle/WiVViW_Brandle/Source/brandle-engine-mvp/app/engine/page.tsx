    ...
    <main className="min-h-screen bg-genesis">
      ...
      <div className="max-w-[1400px] mx-auto px-4 py-5">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
          <div className="lg:col-span-1"><QuoteStrip /></div>
          ...
          <div className="lg:col-span-2 rounded-2xl bg-white/40 backdrop-blur border border-black/5 shadow-sm p-4">
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-2">
                ...
                {!listening ? (
                  <button onClick={startListening} className="px-3 py-2 rounded-xl bg-black/90 text-white hover:bg-black transition text-sm">Start Listening</button>
                ) : (
                  <button onClick={stopListening} className="px-3 py-2 rounded-xl bg-white/70 border border-black/10 hover:bg-white transition text-sm">Stop</button>
                )}
              </div>
            </div>
            ...
            <div className="mt-4 grid grid-cols-1 md:grid-cols-2 gap-3">
              <div className="rounded-xl bg-white/70 border border-black/10 p-3">
                ...
                <div className="mt-2"><RollingLine label="SIGNAL" text={rollingUser || "—"} /></div>
              ...
              <div className="rounded-xl bg-white/70 border border-black/10 p-3">
                ...
                <div className="mt-2"><RollingLine label="OUTPUT" text={rollingAI || (aiAutonomy ? "Autonomy running…" : "—")} /></div>
